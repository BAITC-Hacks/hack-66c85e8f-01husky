...
| Диаризация и привязка поручения к человеку | Акустические группы speaker1, speaker2; ручная привязка имён | Локальная диаризация подключена; автоматическая идентификация человека ещё не готова |
...
| Voiceprint-идентификация, извлечение поручений и саммари | Ещё не реализованы; неизвестные имена не подставляются из списка участников |
