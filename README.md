...
![Поручение рядом с исходной репликой: проверка русской и казахской цитаты, переход к саммари](docs/demo/meeting-evidence.gif)
...
**44 секунды от ссылки на встречу до контроля поручений.** Ролик иллюстрирует сценарий продукта: бот, запись, обработка, черновик, проверка секретарём и исполнение.

![Демо Видео: путь встречи от ссылки и записи до утверждённого протокола и контроля исполнения](docs/demo/kenes-overview.gif)

[Смотреть Демо Видео на Google Drive](https://drive.google.com/file/d/1XTiGx9h5mcA_WB-fe_y8MCoQmDu9jzl7/view?usp=sharing) · [Скачать MP4](demo/Kenes-AI-Demo-v2.mp4?raw=true) · 44 с · 1080p. Анимация иллюстрирует сценарий продукта; далее представлены записи интерфейса.
