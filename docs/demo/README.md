...
Новый [сценарий GIF и видео](media-storyboard.md) содержит согласованный диалог со смешением языков внутри реплик. Документы на этой странице относятся к прежней fake-фикстуре; для будущего видео потребуется отдельный реальный прогон.
