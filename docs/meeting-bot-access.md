...
- Zoom: первый headless запуск показал security challenge. В видимом Chrome бот заполнил имя и нажал Join; затем наш guard ошибочно заблокировал публичный Google iframe. Guard исправлен, повторная живая проверка ожидается.
...
- По сообщению Никиты тестовые камера и микрофон давали анимацию и звук. Тестовые источники заменены светлым логотипом из develop и нулевым WAV. Локальный native WebRTC тест подтвердил 1920×1080 на принимающей стороне, нулевые сэмплы и неизменность кадра. Teams может адаптировать фактическое разрешение; живая проверка 1080p ещё нужна.
